package com.test.servlet.persistance;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3307/job_consultation?characterEncoding=latin1&useConfigs=maxPerformance");
