...
@WebServlet(name = "AllApplicantServlet", urlPatterns = "/allapplicantServlet")

public class AllApplicantServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            List<Applicant> applicantsList = applicantDAO.getAll();

            if (applicantsList != null) {
                sendAsJson(resp, applicantsList);
            } else {
